const Mojitos = {
    "drinks": [
        ...
        },
        {
            ...
            "strInstructions": "Put mint with lemon juice in a glass, mash the mint with a spoon, ice, rum & fill up with club soda. Top it with Angostura.",
            "strInstructionsES": null,
...
for (const mojito of Mojitos.drinks) {
    console.log(`ID: ${mojito.idDrink}, Nombre: ${mojito.strDrink}`); //mojito idDrink se encargara de la busqueda de la id de los mojitos  | ambas lo realizaran recorriendo por ultimo
                                                                      //mojito.strDrink  se encargara de la busqueda del nombre del mojitos | lo imprimiran por pantalla el id y el nombre
